...
class HtmlJadeCommand(sublime_plugin.WindowCommand):
    def run(self, new_file):
        ...
        output = self.html2jade(contents)
        ...
        if output:
            ...
            view.set_syntax_file('Packages/Jade/Syntaxes/Jade.tmLanguage')
            view.end_edit(edit)
